...
//====================Added a new item : click"====================================


  // Private variables
  var axisScale,
      dispatch = d3.dispatch("slide", "slideend","click"),
...
//changed ticks count to number supplied
          axis = d3.svg.axis()
              .ticks(ticks)
    ...
    if (oldPos !== newPos) {
      ...
      if (toType(value) == "array" && value.length == 2) {
        ...
        if (d3.event) {
          ...
          dispatch.click(d3.event.sourceEvent || d3.event, value= newValue);
        };
      }
